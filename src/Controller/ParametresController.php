...
class ParametresController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $parametres = $em->getRepository('App:Parametres')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('App\Form\ParametresType', $parametre);
    ...
    {
        $deleteForm = $this->createDeleteForm($parametre);
        $editForm = $this->createForm('App\Form\ParametresType', $parametre);
